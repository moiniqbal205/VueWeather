...
export default {
  ...
  data () {
    return {
      api_key: 'bbbcbce5a6295b8f66cc29e5200ea962',
...
#app {
  background-image: url('./assets/clear-bg.gif');
...
#app.cloud {
  background-image: url('./assets/cloudy-bg.gif');
}

#app.rain {
  background-image: url('./assets/rainy-bg.gif');
}
